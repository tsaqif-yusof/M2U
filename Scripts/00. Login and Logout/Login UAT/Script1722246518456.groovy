...
WebUI.setText(findTestObject('Object Repository/Page_Maybank2u  Maybank Malaysia/input_Humanising Financial Services_username'), 
    findTestData('Test Data').getValue(1, 2))
...
WebUI.setText(findTestObject('Object Repository/Page_Maybank2u  Maybank Malaysia/input_Hello_my-password-input'), findTestData(
