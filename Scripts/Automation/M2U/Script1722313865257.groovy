...
{ case ('1'): WebUI.callTestCase(findTestCase('03. Pay and Transfer/Transfer/3rd Party'), [:], FailureHandling.CONTINUE_ON_FAILURE)
	break 
	case ('2'): WebUI.callTestCase(findTestCase('03. Pay and Transfer/Transfer/IBFT'), [:], FailureHandling.CONTINUE_ON_FAILURE)
	break 
	...
	break
	case ('5'): WebUI.callTestCase(findTestCase('03. Pay and Transfer/Transfer/IBG'), [:], FailureHandling.CONTINUE_ON_FAILURE)
	break
